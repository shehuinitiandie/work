...
Component({
    ...
    data: {
        ...
        toolList: [
            { content: 'IDE：vscode、webstorm、sublime、hbuilder、微信开发者工具等' },
            { content: '常用工具：npm、vite、webpack、git等' },
            { content: '设计工具：ps、pxcook等' },
            { content: 'UI组件库：ElementPlus、Vant、Iview、Cube等' },
        ]
    },
    lifetimes: {
        attached() {
                    ...
                    [
                        {
                            ...
                            data: [100, 90, 60, 90, 90, 50, 70, 80, 90, 90, 70, 70, 50, 50, 70, 50],
                        },
                    ]
                );
